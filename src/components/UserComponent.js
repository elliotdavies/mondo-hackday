    ...
    if(this.state.user && this.state.outgoing) {
      return (
        <div className="user-component">
          <header>
            <img src={this.getGravatar(this.state.user.email, 350)} />

            <aside>
              <h1>{this.state.user.name} <small>has spent £{(this.state.outgoing/100).toFixed(2)} in the past 7 days</small></h1>
